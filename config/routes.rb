...
#                            motor_cable        /cable                                                  #<ActionCable::Server::Base:0x0000ffffb423c760 @config=#<ActionCable::Server::Configuration:0x0000ffffaffdcfa0 @log_tags=[], @connection_class=#<Proc:0x0000ffffaffbc728 /home/vscode/.rbenv/versions/3.2.5/lib/ruby/gems/3.2.0/gems/actioncable-8.0.2/lib/action_cable/engine.rb:55 (lambda)>, @worker_pool_size=4, @disable_request_forgery_protection=false, @allow_same_origin_as_host=true, @filter_parameters=[:passw, :email, :secret, :token, :_key, :crypt, :salt, :certificate, :otp, :ssn, :cvv, :cvc, /\Aio\z/], @health_check_application=#<Proc:0x0000ffffaffbf6a8 /home/vscode/.rbenv/versions/3.2.5/lib/ruby/gems/3.2.0/gems/actioncable-8.0.2/lib/action_cable/engine.rb:31 (lambda)>, @logger=#<ActiveSupport::BroadcastLogger:0x0000ffffb67ad0f8 @broadcasts=[#<ActiveSupport::Logger:0x0000ffffb67be1f0 @level=0, @progname=nil, @default_formatter=#<Logger::Formatter:0x0000ffffb67af858 @datetime_format=nil>, @formatter=#<ActiveSupport::Logger::SimpleFormatter:0x0000ffffb67ad4b8 @datetime_format=nil, @thread_key="activesupport_tagged_logging_tags:11620">, @logdev=#<Logger::LogDevice:0x0000ffffb476cd20 @shift_period_suffix="%Y%m%d", @shift_size=104857600, @shift_age=1, @filename="/workspaces/zigbee2mqtt-capture/log/development.log", @dev=#<File:/workspaces/zigbee2mqtt-capture/log/development.log>, @binmode=false, @reraise_write_errors=[], @skip_header=false, @mon_data=#<Monitor:0x0000ffffb67af6f0>, @mon_data_owner_object_id=5080>, @level_override={}, @local_level_key=:logger_thread_safe_level_11600>], @progname="Broadcast", @formatter=#<ActiveSupport::Logger::SimpleFormatter:0x0000ffffb67ad4b8 @datetime_format=nil, @thread_key="activesupport_tagged_logging_tags:11620">>, @cable={"adapter"=>"redis", "url"=>"redis://localhost:6379/1"}, @mount_path="/cable", @precompile_assets=true, @allowed_request_origins=/https?:\/\/localhost:\d+/>, @mutex=#<Monitor:0x0000ffffaff86d58>, @pubsub=nil, @worker_pool=nil, @event_loop=nil, @remote_connections=nil>
